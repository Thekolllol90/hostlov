...
public class svar_på_frågor {
	public static void main(String[] args) {
		...
		System.out.println(methoder.power(methoder.delta(methoder.kineticEnergy(740, 0),methoder.kineticEnergy(740, (100/3.6))), 4.4)); //svar 6
		...
		System.out.println(result); //svar 7
